  ...
  return (
    ...
    >
      ...
      <div aria-hidden="true"
        ...
        style={{ background: "radial-gradient(ellipse 80% 60% at 50% 50%, transparent 40%, rgba(2,8,23,0.75) 100%)" }}
      />

      {/* Main content */}
      <div className="relative z-10 max-w-7xl mx-auto w-full px-6 sm:px-10 lg:px-20 pt-28 pb-16 sm:pt-32 sm:pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col gap-7">
            ...
            <AnimatedContent distance={16} direction="vertical" delay={0} duration={0.5}>
              <div className="inline-flex w-fit items-center gap-2.5 px-4 py-1.5 rounded-full
                border border-blue-500/30 bg-blue-500/10 text-blue-300 text-xs font-semibold tracking-wide">
            ...
            <div>
              <h1 className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-black leading-[0.95] tracking-tight">
                <SplitText text={firstName} tag="span" className="block text-white" delay={45} duration={700} from="bottom" />
                <SplitText text={lastName}  tag="span"
                  className="block text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-cyan-400 to-purple-400"
                  delay={45} duration={700} from="bottom" />
              </h1>
            </div>
            ...
            <AnimatedContent distance={20} direction="vertical" delay={0.35} duration={0.6}>
              <div className="flex items-center gap-3 text-xl sm:text-2xl font-semibold text-gray-300">
                <span>I&apos;m a</span>
                <span className="px-3 py-0.5 rounded-lg bg-gradient-to-r from-blue-500/20 to-purple-500/20
            ...
            <AnimatedContent distance={20} direction="vertical" delay={0.45} duration={0.6}>
              <BlurText
                text={personal.bio.length > 140 ? personal.bio.slice(0, 140) + "…" : personal.bio}
                tag="p"
                className="text-gray-400 text-base sm:text-lg leading-relaxed max-w-lg"
                delay={60} duration={500} threshold={0.05}
              />
            </AnimatedContent>
                ...
                <ClickSpark sparkColor="#60a5fa" sparkCount={12} sparkRadius={36}>
                  <a href="#contact"
                    ...
                    className="inline-flex items-center gap-2 px-7 py-3.5
                      ...
                      text-white font-bold rounded-xl text-sm transition-all duration-300 hover:scale-105
          ...
          {/* RIGHT: Photo card */}
          <AnimatedContent distance={60} direction="horizontal" reverse delay={0.2} duration={0.8}
            ...
            <div className="relative w-full max-w-sm">
              ...
              <div className="relative group">
                ...
                <div className="relative bg-gray-900 rounded-2xl overflow-hidden border border-white/10">
                  {hasPhoto ? (
                    ...
                    <div className="w-full aspect-[4/5] relative bg-gradient-to-br from-blue-900/40 via-gray-900 to-purple-900/40 overflow-hidden">
                      {/* eslint-disable-next-line @next/next/no-img-element */}
                      <img src="/images/profile.jpeg" alt={personal.name}
                      ...
                      <span className="text-8xl font-black text-white/20 select-none absolute inset-0 flex items-center justify-center z-10">
                  ...
                  <div className="absolute bottom-0 inset-x-0 p-5">
                    ...
                    <p className="text-blue-400 text-sm mt-0.5">{personal.title || "QA Engineer & Backend Dev"}</p>
              ...
              {/* Social links */}
              <div className="absolute top-1/2 -translate-y-1/2 -left-12 hidden lg:flex flex-col gap-2">
                {personal.socialLinks?.github && (
                  <a href={personal.socialLinks.github} target="_blank" rel="noopener noreferrer" title="GitHub"
                    className="w-8 h-8 rounded-full bg-gray-800/80 border border-gray-700/60 flex items-center justify-center
                      text-gray-400 hover:text-white hover:bg-blue-600/40 hover:border-blue-500/50 transition-all hover:scale-110">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" />
                    </svg>
                  </a>
                ...
                {personal.socialLinks?.linkedin && (
                  <a href={personal.socialLinks.linkedin} target="_blank" rel="noopener noreferrer" title="LinkedIn"
                    className="w-8 h-8 rounded-full bg-gray-800/80 border border-gray-700/60 flex items-center justify-center
                      text-gray-400 hover:text-white hover:bg-blue-700/40 hover:border-blue-600/50 transition-all hover:scale-110">
      ...
      {/* Scroll indicator */}
      <AnimatedContent distance={12} direction="vertical" reverse delay={1.2} duration={0.5}
        className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10">
        <div className="flex flex-col items-center gap-2 text-gray-600 hover:text-gray-400 transition-colors cursor-pointer"
