...
export default function GitHubSection() {
  ...
  return (
    <section id="github" className="py-20 bg-gray-950">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Real-time repositories dan contribution stats langsung dari GitHub
          </p>
        </div>
        ...
        {/* Contribution Graph */}
        <div className="mb-12">
          <h3 className="text-2xl font-bold text-white mb-6">Contributions</h3>
        ...
        <div className="text-center">
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-all transform hover:scale-105 shadow-lg"
          >
